...
M.availability_gps.form.getNode = function(json) {
    ...
    html.push('            <div>');
    html.push('                <label style="height: 1.3em;">' + strings.latitude + '</label><br />');
    html.push('                <label>' + strings.longitude + '</label><br />');
    html.push('                <label>' + strings.accuracy + '</label>');
    html.push('            </div>');
    html.push('            <div>');
    html.push('                <input type="text" name="latitude" value="' + json.latitude + '" size="18" style="width: 100%; max-width: 160px;"/><br />');
    html.push('                <input type="text" name="longitude" value="' + json.longitude + '" size="18" style="width: 100%; max-width: 160px;"/><br />');
    html.push('                <select name="accuracy" style="width: 100%; max-width: 160px;">');
